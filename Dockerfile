...
ARG TARGETARCH
ARG BUILDPLATFORM
WORKDIR /go/src/github.com/nathanejohnson/process-exporter
ADD . .
...
COPY --from=build /go/src/github.com/nathanejohnson/process-exporter/process-exporter /bin/process-exporter
